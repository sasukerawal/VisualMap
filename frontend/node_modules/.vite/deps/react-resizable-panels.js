...
function be(e) {
  if (e.defaultView === null || e.defaultView === void 0)
    return;
  let { prevStyle: t, styleSheet: n } = _e2.get(e) ?? {};
...
function Ut({
  ...
  const x = (0, import_react.useRef)({
    ...
    j(x.current.onLayoutChange, b) || (x.current.onLayoutChange = b, a == null ? void 0 : a(b));
  }), h = oe((b) => {
    j(x.current.onLayoutChanged, b) || (x.current.onLayoutChanged = b, u == null ? void 0 : u(b));
...
function nn({
  ...
  const i = t !== void 0, s = "id" in o ? o.id : o.groupId, l = me(s, t ?? []), r = (0, import_react.useSyncExternalStore)(
    Kt,
    () => n.getItem(l),
    () => n.getItem(l)
...
function qt({
  ...
  const f = !!a, h = xe(a), g = Pe({
    disabled: s
  }), y = (0, import_react.useRef)(null), z = we(y, l), {
    getPanelStyles: S,
    id: p,
    orientation: P,
    registerPanel: R,
...
function Zt({
  ...
  const r = xe(i), a = Pe({
    disabled: n
  }), [u, c] = (0, import_react.useState)({}), [m, d] = (0, import_react.useState)("inactive"), v = (0, import_react.useRef)(null), x = we(v, o), {
    disableCursor: f,
    id: h,
    orientation: g,
    registerSeparator: y,
  ...
  }, [h, r, y, a]), (0, import_react.useEffect)(() => {
    z(r, !!n);
  }, [n, r, z]);
  let p;
  return n && !f && (p = "not-allowed"), (0, import_jsx_runtime.jsx)(
    "div",
    {
      ...l,
